...
*** TODO [R4] Clarify 10 repetitions of each setting
*** TODO [R4] Mention queue thread safety/synchronization
...
*** TODO [R4] Consider longer execution times for statistical significance
...
*** TODO [R2] Improve clarity of Figs. 3-6 (add symbols/patterns)

** Writing / Grammar / Terminology
*** TODO [R1] Explain "escape" terminology
*** TODO [R1] Explain draco/cei nodes
*** TODO [R1] Review grammar consistency
*** TODO [R1] Define all acronyms (MPI, etc.)
...
*** TODO [R3] Evaluate static allocation approach with different granularities and interleaved distribution to workers
*** TODO [R3] Evaluate work-stealing approach
*** TODO [R4] Evaluate our approach with other (more realistic) irregular applications (particle simulation, molecular dynamics, graphs)
*** TODO [R4] Have experiments with (much) longer execution times
