...
also balancing work between workers well. This is supported by Figure [[fig:imbalance-percentage]],
...
time in those cases. Imbalance is also high across granularities in this region, as the work is 
so light that some workers can complete multiple payloads before others receive their first.
