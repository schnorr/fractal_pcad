...
For reproducibility, we provide a companion folder in our repository
with data and scripts used to run the experiment and generate graphs:
\url{https://github.com/schnorr/fractal_pcad/tree/main/papers/2025_SSCAD-WIC/companion}.
