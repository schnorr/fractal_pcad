...
- **Fractal regions:** Three sets of coordinates and max depth values were chosen.
  ...
  - **Hard:** A deep region that is computationally intensive but balanced, testing computational
    throughput.
  These regions can be seen in figures [[fig:region-default]], [[fig:region-easy]], and [[fig:region-hard]].

#+CAPTION: Default fractal region - Max depth of 150,000
#+NAME: fig:region-default
#+ATTR_LATEX: :width 0.45\textwidth :placement [htbp]
[[./figures/region_default.png]]

#+CAPTION: Easy fractal region - Max depth of 1024
#+NAME: fig:region-easy
#+ATTR_LATEX: :width 0.45\textwidth :placement [htbp]
[[./figures/region_easy.png]]

#+CAPTION: Hard fractal region - Max depth of 300,000
#+NAME: fig:region-hard
#+ATTR_LATEX: :width 0.45\textwidth :placement [htbp]
[[./figures/region_hard.png]]
