...
provided the granularity is not too low or too high. In particular, the granularity 20 appears to 
perform the best in those cases, with an efficiency close to 1 in the /hard/ case, and 
approximately 0.88 in the /default/ case. This understanding is likely due to there being a good trade‑off 
