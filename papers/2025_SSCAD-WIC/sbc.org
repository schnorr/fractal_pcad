...
We thank FAPERGS and CNPq for financial support, including
scientific initiation scholarships from FAPERGS (PROBIC) and CNPq
(PBIC). We also thank UFRGS for all institutional support, and the
Parallel and Distributed Processing Research Group for cluster resources.
