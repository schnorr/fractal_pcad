...
- */Payloads/* contêm os limites da região, dimensões da tela, o número máximo de iterações, e a *granularidade* - tamanho em pixels dos blocos em que o trabalho é dividido.
